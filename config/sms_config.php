...
define('SMS_SENDER_ID', 'PhilSMS'); 

// SMS Templates
define('SMS_BOOKING_TEMPLATE', 'GOMS: Appointment booked for [StudentName] with Counselor [CounselorName] on [Date] at [Time]. Case: [BriefConcern]');
...
define('SMS_ADVISER_APPOINTMENT_TEMPLATE', 'GOMS: Appointment for student [StudentName] has been [scheduled/rescheduled/cancelled]. Date: [Date], Time: [Time], Counselor: [CounselorName]');
